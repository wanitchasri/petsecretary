    ...
    <div class="main">
        <div class="main-container">
            ...
            <div class="account-container">
                ...
                <h7>USERNAME</h7>
                <br><br>
                <h10><input type="text" name="username" value="<?php echo $_SESSION['username'];?>"></input></h10>

                <br>

                <div class="rows" action="inc-account-update.php" method="POST">
                    <div class="columns">
                        <br><h7>CONTACT EMAIL </h7>
                        <a href= "#" class="add-ac"></a>
                        <br><br>
                        <h10> <input type="text" name="email" value="<?php echo getEmail(getId()); ?>"> </input></h10>
                        <br><br><h9>This is the email we'll use to contact you</h9>
                        <br>
                        <div class="update">
                            <br><br><input type="submit" name="submit" value="Update"><i3 class="fa fa-chevron-right"></i3></a>
                        </div>
                    </div>
                    <div class="columns">
                        <br><h7 style="margin-left: 15px;">PHONE</h7>
                        <br><br>
                        <h10 style="margin-left: 15px;"><input type="text" name="phone" value="<?php echo getPhone(getId()); ?>"></input></h10>
                        </div>
                    </div>
                    <br>
                    <hr></hr>
