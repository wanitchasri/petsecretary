...
<body>
    ...
    <div class="main">
        ...
        <div class="history-container">
            ...
            <hr></hr>
            <div class="settings">
                    <span class="icon-settings" style="text-align: center;">
                            <div class="sub-menu-settings">
                                <ul>
                                    <li><a href="booking-insert.php">Add</a></li>
                                    <li><a href="booking-update.php">Update</a></li>
            ...
            <table style="width:100%">
                <tr>
                    ...
                    <?php
                        ...
                        $records = mysqli_query($conn,"SELECT * FROM Appointment"); // fetch data from database
                    ...
                    <td><?php echo getPetName($_SESSION['id']); ?></td>
                    <td style="color:rgb(248, 186, 71)"><strong>See</strong><a style="color: rgb(252, 204, 115)" onclick="document.getElementById('modal').style.display='block'" class="seemore"><i class="fa fa-chevron-circle-right"></i></a></td>
                    <?php
                            }
                    ?>
                </tr>
        ...
        <div id="modal" class="bg-modal">
            <div class="modal-content" style=" margin:0 auto; margin-top: 200px;">
                ...
                <div class="modal-card">
                    ...
                    <tr>
                        <h6><?php echo $data['queue_number']; ?></h6><br>
                        <h7><?php echo $data['booking_date']; ?></h7>
                        <br>
                        <h8></h8>
                        <br><br><h9>><?php echo $data['booking_time']; ?></h9><br>
                    </div>

                <div class="modal-info" style="text-align: left; padding-left: 50px;">
                    <h8><?php echo $data['treatment']; ?></h8><br>
                    <br><h10></h10><br>
                    <h10></h10><br>
                    <br>
                    <h10><b>Patient:</b> <?php echo getPetName($data['queue_number']); ?></h10><br>
            ...
            <div class="postpone"><a href="4-appointments_process.php">Postpone</a></div> <div class="cancel"><a href="6-bookings-cancel.php">Cancel</a></div>
