    ...
    <div class="main">
        <div class="main-container">
            ...
            <div class="account-container">
                ...
                <hr></hr>
                <h8>Login Email: email@hotmail.com</h8><br>
                <br>
                <h7>FULL NAME</h7>
                <br>
                <input type="text" class="input2" value="Boo Boo">
                ...
                <div class="rows">
                    <div class="columns">
                        ...
                        <br>
                        <input type="text" class="input" value="email@hotmail.com">
                        <br><h9>This is the email we'll use to contact you</h9>
                        <br>
                        <div class="update">
                            <br><br><a href="9-account.php">Update Info <i3 class="fa fa-chevron-right"></i3></a>
                        </div>
                    </div>
                    <div class="columns">
                        <br><h7>PHONE <a href="#"></h7>
                        <a href= "#" class="add-ac"><i6 class="fa fa-plus-circle"></i6></a>
                        <br>
                        <input type="text" class="input" value="0899999999">
                        </div>
                    </div>
                    <br>
                    <hr></hr>
